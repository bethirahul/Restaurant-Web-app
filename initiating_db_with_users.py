...
restaurant1 = Restaurant(creater_id=2, name="Urban Burger")
...
menuItem5 = MenuItem(creater_id=2, name="Root Beer", description="16oz of refreshing goodness",
...
menuItem7 = MenuItem(creater_id=2, name="Grilled Cheese Sandwich",
...
restaurant2 = Restaurant(creater_id=1, name="Super Stir Fry")

session.add(restaurant2)
session.commit()


menuItem1 = MenuItem(creater_id=1, name="Chicken Stir Fry", description="With your choice of noodles vegetables and sauces",
                     price="7.99", course="Entree", restaurant=restaurant2)

session.add(menuItem1)
session.commit()

menuItem2 = MenuItem(creater_id=1, name="Peking Duck",
...
menuItem3 = MenuItem(creater_id=1, name="Spicy Tuna Roll", description="Seared rare ahi, avocado, edamame, cucumber with wasabi soy sauce ",
...
menuItem6 = MenuItem(creater_id=1, name="Ramen", description="a Japanese noodle soup dish. It consists of Chinese-style wheat noodles served in a meat- or (occasionally) fish-based broth, often flavored with soy sauce or miso, and uses toppings such as sliced pork, dried seaweed, kamaboko, and green onions.",
                     price="12", course="Entree", restaurant=restaurant2)
...
restaurant1 = Restaurant(creater_id=2, name="Panda Garden")
...
menuItem3 = MenuItem(creater_id=2, name="Gyoza", description="light seasoning of Japanese gyoza with salt and soy sauce, and in a thin gyoza wrapper",
...
restaurant1 = Restaurant(creater_id=1, name="Thyme for That Vegetarian Cuisine ")

session.add(restaurant1)
session.commit()


menuItem1 = MenuItem(creater_id=1, name="Tres Leches Cake", description="Rich, luscious sponge cake soaked in sweet milk and topped with vanilla bean whipped cream and strawberries.",
...
menuItem3 = MenuItem(creater_id=1, name="Honey Boba Shaved Snow",
...
menuItem4 = MenuItem(creater_id=1, name="Cauliflower Manchurian", description="Golden fried cauliflower florets in a midly spiced soya,garlic sauce cooked with fresh cilantro, celery, chilies,ginger & green onions",
                     price="6.95", course="Appetizer", restaurant=restaurant1)

session.add(menuItem4)
session.commit()

menuItem5 = MenuItem(creater_id=1, name="Aloo Gobi Burrito", description="Vegan goodness. Burrito filled with rice, garbanzo beans, curry sauce, potatoes (aloo), fried cauliflower (gobi) and chutney. Nom Nom",
...
restaurant1 = Restaurant(creater_id=1, name="Tony\'s Bistro ")

session.add(restaurant1)
session.commit()


menuItem1 = MenuItem(creater_id=1, name="Shellfish Tower", description="Lobster, shrimp, sea snails, crawfish, stacked into a delicious tower",
                     price="13.95", course="Entree", restaurant=restaurant1)

session.add(menuItem1)
session.commit()

menuItem2 = MenuItem(creater_id=1, name="Chicken and Rice", description="Chicken... and rice",
                     price="4.95", course="Entree", restaurant=restaurant1)

session.add(menuItem2)
session.commit()

menuItem3 = MenuItem(creater_id=1, name="Mom's Spaghetti", description="Spaghetti with some incredible tomato sauce made by mom",
...
menuItem5 = MenuItem(creater_id=1, name="Tonkatsu Ramen", description="Noodles in a delicious pork-based broth with a soft-boiled egg",
                     price="7.95", course="Entree", restaurant=restaurant1)
...
# Menu for Andala's
restaurant1 = Restaurant(creater_id=2, name="Andala\'s")
...
restaurant1 = Restaurant(creater_id=1, name="Auntie Ann\'s Diner' ")

session.add(restaurant1)
session.commit()

menuItem9 = MenuItem(creater_id=1, name="Chicken Fried Steak",
...
menuItem2 = MenuItem(creater_id=1, name="Broiled salmon", description="Salmon fillet marinated with fresh herbs and broiled hot & fast",
                     price="10.95", course="Entree", restaurant=restaurant1)

session.add(menuItem2)
session.commit()

menuItem3 = MenuItem(creater_id=1, name="Morels on toast (seasonal)",
...
menuItem4 = MenuItem(creater_id=1, name="Tandoori Chicken", description="Chicken marinated in yoghurt and seasoned with a spicy mix(chilli, tamarind among others) and slow cooked in a cylindrical clay or metal oven which gets its heat from burning charcoal.",
...
menuItem10 = MenuItem(creater_id=1, name="Spinach Ice Cream", description="vanilla ice cream made with organic spinach leaves",
...
restaurant1 = Restaurant(creater_id=1, name="Cocina Y Amor ")
...
menuItem2 = MenuItem(creater_id=1, name="Cachapa", description="Golden brown, corn-based Venezuelan pancake; usually stuffed with queso telita or queso de mano, and possibly lechon. ",
                     price="7.99", course="Entree", restaurant=restaurant1)
...
restaurant1 = Restaurant(creater_id=1, name="State Bird Provisions")
session.add(restaurant1)
session.commit()

menuItem1 = MenuItem(creater_id=1, name="Chantrelle Toast", description="Crispy Toast with Sesame Seeds slathered with buttery chantrelle mushrooms",
                     price="5.95", course="Appetizer", restaurant=restaurant1)

session.add(menuItem1)
session.commit

menuItem1 = MenuItem(creater_id=1, name="Guanciale Chawanmushi",
